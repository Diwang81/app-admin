  ...
  class RegistrationForm extends React.Component {
    ...
    handleWebsiteChange = value => {
      ...
      if (!value) {
        ...
        autoCompleteResult = ['.com', '.org', '.net', '.co.id'].map(domain => `${value}${domain}`);
      }
        ...
        <Form {...formItemLayout} onSubmit={this.handleSubmit}>
          ...
          <Form.Item {...tailFormItemLayout}>
            {getFieldDecorator('agreement', {
              ...
              <Checkbox>
                I have read the <a href="cek">agreement</a>
              </Checkbox>,
            )}
          </Form.Item>
          <Form.Item>
              ...
              <Button type="link" className="Button" > <Link to="/"> <Icon type="user"/> Already have a account? </Link></Button>
          </Form.Item>
        </Form>
        </Card>
      </div>
